...
def signup():
    ...
    if username == "": # Validate Username
        ...
        username_error = "Your username can't contain any spaces."
        username = ""
    ...
    if password == "": # Validate Password
        ...
        password_error = "Your password can't contain any spaces."

    if verify == "" or verify != password: # Verify Password
        verify_error = "Passwords don't match. Try again."
        verify = ""

    if email != "": # Validate Email
        # Used regex for complete validation.
